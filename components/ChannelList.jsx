...
let channelList=channels.map((item,i)=>{  //this is group channels list
    return(<ListItem key={i} value={channelSelectable[i]} primaryText={item} 
                    onTouchTap={this.handleChange.bind(this,item)} 
                    rightIcon={<Badge badgeContent={this.props.unreadCount[this.state.currentProject+'#'+item]} 
                    primary={true}></Badge>}/>)
            });
...
console.log("this is currentchannel",this.props.currentChannel);
console.log(channelList,DMListfiltered);
