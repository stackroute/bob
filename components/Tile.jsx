...
export default class Tile extends React.Component{
	...
	componentWillMount(){
		let that = this;
		request
			.get('http://172.23.238.164:8000/user/'+this.props.userId+'/Tiles/'+this.props.tileId+"/Messages")
	...
	componentDidMount(){
		let that = this;
		request
			.get('http://172.23.238.164:8000/user/'+this.props.userId+'/Tiles/'+this.props.tileId)
	...
	handleEdit(){
		let that = this;
		request
			.get('http://172.23.238.164:8000/user/'+this.props.userId+'/channels')
			.end(function(err,reply){
				reply = JSON.parse(reply.text);
				if(!reply.result)
	...
	handleSave(){
		request
			.patch('http://172.23.238.164:8000/user/'+this.props.userId+'/Tiles/'+this.props.tileId)
